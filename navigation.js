...
(function () {
  ...
  mount.outerHTML = `<header class="site-header"><a class="wordmark" href="property-exchange-cards.html#top" aria-label="Property Exchange home"><span class="wordmark-mark" aria-hidden="true">PX</span><span>Property Exchange</span></a><nav class="site-nav" aria-label="Primary navigation"><a href="property-exchange-cards.html"${investmentsCurrent}>Investments</a><a href="content.html"${contentCurrent}>Content</a><a href="about.html"${aboutCurrent}>About Us</a></nav><span class="header-note">${current === "investments" ? "New opportunities, thoughtfully selected" : "Learn with clarity. Invest with confidence."}</span></header>`;
})();
